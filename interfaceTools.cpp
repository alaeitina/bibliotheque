...
vector<Adherent*> fixturesAdherents(vector<Bibliotheque*> listeBibliotheque){
    vector<Adherent*> listeAdherents;
    for (auto i=0; i<listeBibliotheque.size(); i++) {
        Adherent Isam = Adherent("Ben Soltane", "Isam", listeBibliotheque[i]);
        Adherent Leo = Adherent("Laurent", "Leo", listeBibliotheque[i]);
...
Adherent formAdherent(Bibliotheque* bibliotheque, Adherent* adherent) {
...
TypeLivre formLivre(TypeLivre* livre){
    ...
    do {
        ...
        switch (choix) {
            ...
            case 3:
                ...
                cout << "1. Ajouter de nouveau livres a la vente" << endl;
                ...
                break;
            case 4:
                cout << "Vous allez quitter l'interface ..." << endl;
                quitter = true;
                break;
            default:
